               ...
               <CRow>
                 <CCol md={6}>
                   ...
                   <p>
                     ...
                     inception, servicing many industries in the country, including Corporate Sector,<br/>                     Banking, Finance, Insurance, Legal, Healthcare, Entertainment, Government,<br/>
...
// } from '@coreui/react';
// import CIcon from '@coreui/icons-react';
// import { cibFacebook, cibInstagram, cibWhatsapp, cibLinkedin, cilClock, cilEnvelopeClosed, cilPhone } from '@coreui/icons';
...
// import trackImg from '../../assets/images/Blurr.jpg';
// import companyImg from '../../assets/images/Company.png';
// import aboutImg from '../../assets/images/white.avif';
...
//               <CImage src={yoga} height={75} width={75} />
//               Yoga Transport
//               <div><h6>We keep improving to serve you better!</h6></div>
//             </CNavbarBrand>
//             <CCollapse className='navbar-collapse justify-content-end' visible>
//               <CNavbarNav>
//                 <CNavItem>
//                   <CIcon icon={cilPhone} size="xl" style={{'--ci-primary-color': 'orange'}} />
//                   Call Us: <CNavLink href='#'>0762110846</CNavLink>
//                 </CNavItem>
//                 <CNavItem>
//                   <CIcon icon={cilEnvelopeClosed} size="xl" style={{'--ci-primary-color': 'orange'}} />
//                   Email Us: <CNavLink href='#'>lasibala24@gmail.com</CNavLink>
//                 </CNavItem>
//                 <CNavItem>
//                   <CIcon icon={cilClock} size="xl" style={{'--ci-primary-color': 'orange'}} />
//                   Opening Hours: <CNavLink href='#'>Mon-Fri: 8am – 7pm</CNavLink>
//                 </CNavItem>
//               </CNavbarNav>
//               <CButton type='submit' color='warning' href='/login'>Login</CButton>
//             </CCollapse>
//           </CContainer>
//         </CNavbar>
//       </CCard>
...
//                   <CContainer>
//                     <CCardText className="d-none d-md-block">
//                       <h1 style={{ color: 'black' }}>Welcome to Our Courier Management System</h1>
//                       <p style={{ color: 'black' }}>Efficient, reliable, and secure courier services at your doorstep.</p>
//                     </CCardText>
//                   </CContainer>
//                 </CCardImageOverlay>
...
//                   <CContainer>
//                     <CCardText className="d-none d-md-block">
//                       <h1 style={{ color: 'black' }}>The Largest Domestic Courier Service Provider in Sri Lanka</h1>
//                       <p style={{ color: 'black' }}>
//                         We offer a complete array of services tailored to provide the best logistics.
//                       </p>
//                     </CCardText>
//                   </CContainer>
//                 </CCardImageOverlay>
...
//       <CCard>
//         <CImage className="d-block w-100" src={trackImg} alt="Track Your Item" height={700} />
//         <CCardImageOverlay>
//           <CContainer>
//             <CCardText className="d-none d-md-block text-center">
//               <h1 style={{ color: 'white' }}><strong>Track Your Item</strong></h1>
//             </CCardText>
//             <CForm>
//               <CRow className="mb-3 text-center">
