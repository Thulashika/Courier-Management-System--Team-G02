    ...
    <CRow xs={{ cols: 1, gutter: 4 }} md={{ cols: 3 }} >
      <CCol xs>
        <CCard className="card mb-3" style={{ width: '18rem' }}>
          ...
          {/* <CIcon icon={cilBuilding} size='60px' className='justify-content-end'/> */}
        </CCard>
      </CCol>
      ...
      <CCol xs>
        <CCard className="card mb-3" style={{ width: '18rem' }}>
          ...
          {/* <CCardImage src={parcel} alt='view' height={80} width={30}/> */}
        </CCard>
      </CCol>
      ...
      <CCol xs>
        <CCard className="card mb-3" style={{ width: '18rem' }}>
          ...
          {/* <CCardImage src={userGroup} alt='view' height={80} width={40}/> */}
        </CCard>
      </CCol>
    </CRow>
