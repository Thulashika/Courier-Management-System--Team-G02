...
//             <CCol md={10}>
//                {/* Main Welcome Card */}
//                <CCard className="p-4" style={backgroundStyle(service)}>
//                   <CRow>
//                      <CCol>
//                         <CCardBody>
//                            <h1>Welcome to Our Courier Service</h1>
...
//                {/* Services Section */}
//                <CCard className="p-4 align-items-center" style={backgroundStyle(serviceBackground)}>
//                   <CRow><strong>SERVICES</strong></CRow>
//                   <CRow><h4>Our services for you</h4></CRow>
//                   <CRow className='mb-3'>
//                      <CCol md={4}>
...
//                                  Name
//                                  <CFormInput id="name" type="text" name="name" value={state.name} onChange={handleChange} required />
//                               </CFormLabel>
//                            </div>
//                            <div className="form-group">
//                               <CFormLabel htmlFor="email">
//                                  Email
//                                  <CFormInput id="email" type="email" name="email" value={state.email} onChange={handleChange} required />
//                               </CFormLabel>
//                            </div>
//                            <div className="form-group">
//                               <CFormLabel htmlFor="phone">
//                                  Phone Number
//                                  <CFormInput id="phone" type="tel" name="phone" value={state.phone} onChange={handleChange} />
//                               </CFormLabel>
//                            </div>
//                            <div className="form-group">
//                               <CFormLabel htmlFor="message">
//                                  Message
//                                  <CFormTextarea id="message" name="message" rows="4" value={state.message} onChange={handleChange} required />
//                               </CFormLabel>
//                            </div>
//                            <CButton type="submit" color='primary'>Submit</CButton>
